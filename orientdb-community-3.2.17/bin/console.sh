...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-3.2.17.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="UNKNOWN@r211ebdf4e697bc32a41a4456f09b4c47f2a4eb4b; 2023-03-07 11:38:34+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-3.2.17.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \

...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="UNKNOWN@r211ebdf4e697bc32a41a4456f09b4c47f2a4eb4b; 2023-03-07 11:38:34+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-3.2.17.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
